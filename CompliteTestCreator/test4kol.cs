...
{
    public partial class test4kol : Form
    {
        ...
        public test4kol(bool isStud, string filename)
        {
            InitializeComponent();
            ...
            To4listBox.HorizontalScrollbar = true;
            ...
            To4TextBox.Text = streamReader.ReadLine();
            while (true)
            {
            ...
            M.ResetButtonClick(To1listBox, To2listBox, To3listBox, To4listBox, fromListBox);
            M.RestartButtonClick(AnsverList, fromListBox, K);
        }

        private void test4kol_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void To4listBox_Click(object sender, EventArgs e)
        {
            M.MoveFromTo(listBox, To4listBox);
        }

        private void To4listBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            M.ChangeIndex(To4listBox, ref listBox);
        }
        ...
        private void ResultButton_Click(object sender, EventArgs e)
        {
            if (fromListBox.Items.Count == 0)
                ResultTextBox.Text = M.ResultButtonClick(AnsverList, To1listBox, To2listBox, To3listBox, To4listBox).ToString() + '/' + M.Count(To1listBox, To2listBox, To3listBox, To4listBox).ToString();
        }
        ...
        private void TeacherAccess()
        {
            ...
            this.To4TextBox.ReadOnly = IsStudent;
